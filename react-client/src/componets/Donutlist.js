...
import {donotdata}from '../data/donotdata'
import {Link} from 'react-router-dom'
export default class Donutlist extends Component {
constructor(props){
super(props)
this.state={
    donotdata
...
return (
    <div>
        <ul className="row ">
        {this.state.donotdata.map(value =><li key={value.id} className="col-md-6 ml-auto mb-4">
